...
class Badge(models.Model):
    is_first_avatar_change = models.BooleanField(
        default=False, blank=False, null=False)
    is_first_review = models.BooleanField(
        default=False, blank=False, null=False)
    shared_count = models.PositiveSmallIntegerField(
        default=0, blank=False, null=False)
    is_first_save_store = models.BooleanField(
        default=False, blank=False, null=False)
